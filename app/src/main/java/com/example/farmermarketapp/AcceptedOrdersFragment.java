...
public class AcceptedOrdersFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view,
        ...
        recyclerView = view.findViewById(R.id.recyclerAcceptedOrders);
        tvEmpty      = view.findViewById(R.id.tvEmpty);

        orderList = new ArrayList<>();
        adapter   = new FarmerOrderAdapter(
                getContext(), orderList, "accepted", this::onDeliver);
    ...
    private void onDeliver(FarmerOrderModel order, String action) {
